...
def mock_weaviate(monkeypatch):
    class DummyWeaviateClient:
        def index_table(self, *args, **kwargs): pass
        def query(self): return self
        def get(self, *args, **kwargs): return self
        def with_near_text(self, *args, **kwargs): return self
        def with_additional(self, *args, **kwargs): return self
        def do(self): return {"data": {"Get": {"TableDoc": []}}}

    monkeypatch.setattr("assistant.application.table_store.WeaviateClient", DummyWeaviateClient)
